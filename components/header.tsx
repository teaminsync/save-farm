...
//               <Image
//                 src={(isScrolled || isMobileMenuOpen) ? '/images/save-farm-logo2-scrolled.svg' : '/images/save-farm-logo2.svg'}
//                 alt="Save Farm Logo"
//                 fill
//                 className="object-contain"
//               />
//             </div>
//             <span className={`ml-2 font-serif text-xl ${isScrolled || isMobileMenuOpen ? 'text-fern' : 'text-warm-ivory'}`}>
//               SAVE FARM
//             </span>
//           </div>
//         </Link>
...
//               className="fixed inset-0 bg-warm-ivory z-40 flex flex-col items-center justify-center"
//             >
