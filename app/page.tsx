      ...
      <section className="py-20 bg-warm-ivory" data-scroll-section ref={introRef}>
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              At Save Farm, we believe in creating a sanctuary where people can escape the hustle of modern life and
              reconnect with the natural world. Our sustainable practices and luxurious accommodations offer a perfect
              balance of comfort and authenticity, allowing you to experience the serenity of rural life without
